...
This README is package-facing. It assumes your current working directory is this `labsuite/` directory.
...
All path examples below assume your current working directory is this `labsuite/` directory.
